...
/**
 * Front controller for User's.
 * This would be the site's users, where they can register, unregister
 * edit their profile and login into the front end.
 * We provide a different url and registration form.
 * This way they don't have to see the admin in their url's
 * 
 * TODO Implement.
 */
class Controller_User extends Controller_Layout 
{
	...
	protected function _redirect_user($uri = NULL, $override_uri = NULL )
	{
	}
