 ...
 *
 */
class Core_ORM extends Kohana_Auth_ORM {
	...
	protected function _login($user, $password, $remember) 
	{
		...
		if (($this->_config["emb-admin"]["max_failed_logins"] > 0) && 
			($user->failed_login_count >= $this->_config["emb-admin"]["max_failed_logins"] ) && 
			(strtotime($user->last_failed_login) > strtotime("-".$this->_config["emb-admin"]["login_jail_time"] ) )) 
		{
